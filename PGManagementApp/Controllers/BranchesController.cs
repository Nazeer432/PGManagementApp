...
namespace HostelManagementApp.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public BranchesController(IBranchRepository branchRepository, IUserProfileRepository userProfileRepository, IHostelRepository hostelRepository)
        {
        ...
        public async Task<IActionResult> Create([Bind("PkbranchId,BranchName,Location")] Branch branch)
        {
            if (true)
            {
