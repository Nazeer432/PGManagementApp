...
namespace Data.Migrations
{
    ...
    [Migration("20230508172901_AddedNewGuestTables3")]
    partial class AddedNewGuestTables3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.GuestDetail", b =>
                {
                    b.Property<int>("GuestDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GuestDetailId"), 1L, 1);
            ...
            modelBuilder.Entity("Data.Models.GuestUser", b =>
                {
                    ...
                    b.Property<int?>("FkGuestDetailId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProodId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<byte?>("ProofName")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Data.Models.GuestUser", b =>
                {
                    b.HasOne("Data.Models.GuestDetail", "FkGuestDetail")
                        .WithMany("GuestUsers")
                        .HasForeignKey("FkGuestDetailId");

                    b.Navigation("FkGuestDetail");
                });
